  ...
  const t = await getTranslations("index");
    const projects = [
        ...
        },
        {
            ...
            image: "/azure.png",
            items: ["NextJs","DaisyUi","NextAuth","Azure API"],
            link: "https://github.com/alexdissi/cloud_exo"
        }
    ];
