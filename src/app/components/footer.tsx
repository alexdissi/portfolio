  ...
  return (
    <footer data-aos="zoom-in">
      <div className="flex flex-col gap-3 md:flex-row justify-between items-center">
        <div>
          <a href="mailto:alexandredissi@icloud.com,">
            alexandredissi@icloud.com
          </a>
        </div>
        <div>
          <a href="#">
      ...
      <h3 className="text-center mt-5 font-sans">
        Built by Alexandre Dissi with{" "}
        <span className="text-rose-700">Love ❤️</span>{" "}
      </h3>
    </footer>
  );
}
